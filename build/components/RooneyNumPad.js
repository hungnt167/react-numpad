...
exports.default = function (_ref) {
  ...
  var RooneyNumPad = function (_Component) {
    _inherits(RooneyNumPad, _Component);

    function RooneyNumPad(props) {
      _classCallCheck(this, RooneyNumPad);

      var _this = _possibleConstructorReturn(this, (RooneyNumPad.__proto__ || Object.getPrototypeOf(RooneyNumPad)).call(this, props));
    ...
    _createClass(RooneyNumPad, [{
      ...
      value: function toggleKeyPad() {
        ...
        var inputCoords = !this.state.show && _helper2.default[position] ? (0, _helper.toCss)(coords, position, 0, 0, this.props) : undefined;
