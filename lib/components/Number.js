...
import RooneyNumPad from './RooneyNumPad';
import { KeyPad, RooneyKeyPad } from '../elements';
...
const Rooney = RooneyNumPad(beautyProps(PositiveValidation));

export { Number, PositiveNumber, IntegerNumber, PositiveIntegerNumber, Rooney };
