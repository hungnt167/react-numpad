...
function castYValid(coords, position, isForce, minY, props) {
  /** top over top window */
  ...
  if (position.top > window.innerHeight - props.height) {
    return Object.assign(position, {
      top: window.innerHeight - props.height - coords.height,
    });
  }
...
export function toCss(coords, position, minY, props) {
  ...
  const data = isSameTop ? positionFinal : castYValid(coords, positionFinal, isCenter, minY, props);
